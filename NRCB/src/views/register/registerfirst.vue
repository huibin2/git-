	   ...
	   <div class="wrapper">
		   <div class="banker" style="margin-top: 20px;">
			   <div class="banker-bottom">
				      <text class="title">注册手机号</text>
				      <input class="tit" maxlength="11" v-model="phoneNo" placeholder="请输入注册手机号" @input="getPhoneNo" type="number"/>  
         </div>
         <div class="line"></div>
				<div class="banker-bottom">
        ...
        <div class="line"></div>
				<div class="banker-bottom">
				   ...
				   <input class="tit" ref="refereeref" maxlength="6" minlength="4" v-model="refereeNo" placeholder="请输入推荐人工号或手机号码(选填)" @input="getRefereeNo" type="number"/>
			   </div>
		   </div>
		   <div  class="button4" @click="registSec"><text class="text">下一步</text></div>
	   </div>
...
export default {
  ...
  methods: {
    ...
    getMsgCode(event){
      context.sessionSetString('RegisterMsgCode',event.value);
    },
    getName(event) {
