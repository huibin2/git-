<template>
    ...
    <div>
        <title-bar titleJson="tab_user/safe_set/ATM_titlebar.json"></title-bar>
        ...
        <div class="bank_center">
                ...
                <div class="bank">
                     ...
                     encryptType=22 publicKey kbdRandom="true" class="input">
                      ...
                      <input type="password" class="input2" placeholder="请输入交易密码" @input="getPwd">
                </div>
