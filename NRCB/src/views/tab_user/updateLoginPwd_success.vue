<template>
    <div>
        <title class="titlebar" titleJson="tab_user/safe_set/updatePwdSuc_titlebar.json"></title>
        <scroller class="container">
          <div class="home">            
            ...
            <div class="img_area">
                ...
                <text class="text">登录密码修改成功，下次登录需要使用新登录密码</text>
            </div>
            ...
            <div class="btn" @click="confirm">
                <text class="btntext" style="font-size:36px">确定</text>
            </div>
          </div>
        </scroller>
